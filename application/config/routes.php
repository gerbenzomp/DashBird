...
// route pages
$route['page/([a-z0-9-.]+)'] = 'default_controller/index/default/pages/show/$1';
$route['page/([a-z0-9-.]+)/([a-z0-9-.]+)'] = 'default_controller/index/default/pages/show/$1/$2'; // page numbers
$route['([a-z0-9-.]+)/page/([a-z0-9-.]+)'] = 'default_controller/index/$1/pages/show/$2';
$route['([a-z0-9-.]+)/page/([a-z0-9-.]+)/([a-z0-9-.]+)'] = 'default_controller/index/$1/pages/show/$2/$3'; // page numbers


// route posts
$route['post/([a-z0-9-.]+)'] = 'default_controller/index/default/posts/show/$1';
$route['post/([a-z0-9-.]+)/([a-z0-9-.]+)'] = 'default_controller/index/default/posts/show/$1/$2';
$route['([a-z0-9-.]+)/post/([a-z0-9-.]+)'] = 'default_controller/index/$1/posts/show/$2';
$route['([a-z0-9-.]+)/post/([a-z0-9-.]+)/([a-z0-9-.]+)'] = 'default_controller/index/$1/posts/show/$2/$3';
